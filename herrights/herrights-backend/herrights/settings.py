"""
Django settings for herrights project.
...
SECRET_KEY = 'django-insecure-*x3*51+az0v&!^yf3hfeo(&*a@04crau_jm!@$itecd%!#3map'
...
WSGI_APPLICATION = 'herrights.wsgi.application'
